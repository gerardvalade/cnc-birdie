...
difference() 
{
	...
	translate([0, 0, -0.02]) rotate([180,0,0]) nutcatch_parallel("M5", l=5);
	translate([0, 0, -0.02]) rotate([180,0,0]) nutcatch_parallel("M5", l=4, clk=0.3);
	translate([0, 0, 50+0.02]) hole_through(name="M5", l=50+5, cld=0.1, h=10, hcld=0.4);
	translate([55, 0, 9]) nutcatch_sidecut("M8", l=100, clk=0.1, clh=0.1, clsl=0.1);
	translate([55, 20, 50+0.02]) hole_through(name="M8", l=50+5, cl=0.1, h=10, hcl=0.4);
	translate([27.5, 0, 50.01]) hole_threaded(name="M5", l=60);
}
